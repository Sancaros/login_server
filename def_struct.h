...
typedef struct NO_ALIGN st_chardata {
	...
	INVENTORY_ITEM inventory[30]; // 0x0C-0x353 //30格背包 12 - 851 840 整数 PacketE8
	...
	BANK_ITEM bankInventory[200]; // 0x708 - 0x19C7 1800 - 6599 200 整数 //名片相关的// Stored from E8 06 packet.
